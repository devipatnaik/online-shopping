			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form method="POST" class="form-horizontal" id="billingForm"
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="addressLineOne">City</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="addressLineOne">Postal
								Code</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="addressLineOne">State</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="addressLineOne">Country</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-8">
								...
								<!-- Submit button for moving to the Confirmation -->
								<button type="submit" class="btn btn-primary"

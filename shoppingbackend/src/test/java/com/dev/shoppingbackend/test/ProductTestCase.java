...
public class ProductTestCase {
	...
	public void testCRUDProduct(){
		...
		product.setDescription("This is really a awesome phone with latest features!!");
	...
	public void testListActiveProductsByCategory(){
		...
		assertEquals("Something went wrong while fetching list of products by category!!!", 3, productDAO.listActiveProductsByCategory(3).size());
		
		assertEquals("Something went wrong while fetching list of products by category!!!", 2, productDAO.listActiveProductsByCategory(1).size());
	...
	public void testGetLatestActiveProduct(){
		...
		assertEquals("Something went wrong while fetching list of products by category!!!", 3, productDAO.getLatestActiveProducts(3).size());
